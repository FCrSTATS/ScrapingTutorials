...
This is a R conversion of a tutorial by FC Python ([linked phrase](http://twitter.com/FC_Python)). I take no credit for the idea and have their blessing to make this conversion. All text is a direct copy unless changes were relevant. Please follow them on twitter and if you have a desire to learn Python then they are a fantastic resource!
